...
const TITLE = "Cliff Hsia: How to Negotiate Your Salary to Get Paid More"
const SPEAKERS = ["Cliff Hsia: How to Negotiate Your Salary to Get Paid More (9/2 7pm EDT)"]
