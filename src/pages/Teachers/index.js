...
const TeacherHome = ({ setPage }) => {
  return (<>
    ...
    */}
    ...
    <Typography.BodyText color="black" fontSize="20px" style={{ marginBottom: 30 }}>
      Have any questions? Email us at <a href = "mailto: wavelearningfestival@gmail.com" style={{color: Colors.WLF_PURPLE}}>wavelearningfestival@gmail.com</a> or check out our FAQs page for instructors <a href="/faq-instructors" color={Colors.WLF_YELLOW}>here</a>!
    </Typography.BodyText>
