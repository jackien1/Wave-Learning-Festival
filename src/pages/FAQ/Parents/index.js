...
const seminarsFAQ = [
  {
    ...
    question: "How can I ensure the material is appropriate for my child?",
    answer: "Each seminar’s description outlines the content that will be covered, as well as the suggested audience."
  },{
    question: "Does my child need to have any previous experience in the seminar topic to enroll in a seminar?",
    ...
    answer: <p>Wave runs on the goodwill of students looking out for other students. Feel free to share this resource with anyone you think could benefit from any of our programs! In addition, we also accept donations <a href="/donate" color={Colors.WLF_PURPLE}>here</a>, if you have the means!</p>
  },{
...
const tutoringFAQ = [
  {
    ...
    question: "How can my child sign up?",
    ...
    question: "Does my child need to stay for the entire tutoring session?",
    answer: "No, students are free to leave anytime during the session, once their questions have been answered."
  },{
    question: "How do I contact my child's tutor outside of a session?",
