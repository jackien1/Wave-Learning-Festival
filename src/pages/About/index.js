              ...
              >
                ...
                <Typography.BodyText style={{ color: 'white', fontSize: 16, fontWeight: '100' }}>
                  <ul style={{ marginTop: -10, marginLeft: -25, lineHeight: 1.5 }}>
                    ...
                    <li>The deadline for instructor applications for Tide 1 has been extended to Tuesday 9/8! <a href="/instructors" style={{ color: Colors.WLF_YELLOW }}>Learn More</a></li>
